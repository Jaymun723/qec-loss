...
class DetsRerouter:
    @typing.overload
    def __init__(
        self, circuit: typing.Any, data_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex]
    ) -> None: ...
    @typing.overload
    ...
    def reroute(
        self,
        observable_index: typing.SupportsInt | typing.SupportsIndex,
        lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        optimize: bool = False,
    ) -> list: ...
    @property
...
class ForwardSampler(Sampler):
    ...
    def sample(
        self,
        num_samples: typing.SupportsInt | typing.SupportsIndex,
        reroute_observables: bool = False,
        optimize_retoute: bool = False,
    ) -> SampleBatch:
        """
    ...
    ) -> tuple[numpy.typing.NDArray[numpy.uint8], list[list[tuple[int, list[int]]]]]:
        """
...
class LifeSegment:
    ...
    def __init__(
        self,
        qubit: typing.SupportsInt | typing.SupportsIndex,
        start: typing.SupportsInt | typing.SupportsIndex,
...
class MonakaBuilder:
    ...
    def __init__(self, circuit: LossyCircuit, optimize_rerouting: bool = False) -> None:
        ...
        """
    def decode_batch(
        self, batch: SampleBatch, include_loss_dem: bool = True, post_select_on_usable_shots: bool = True
    ...
    def get_life_segment_dem(
        self, arg0: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], arg1: LifeSegment
    ) -> typing.Any:
        """
        Get the DEM restricted to a specific life segment.
        """
    def get_nominal_dem(
        self, lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex] = []
    ) -> typing.Any:
        """
...
class PackedF2Matrix:
    ...
    def __init__(
        self, rows: typing.SupportsInt | typing.SupportsIndex, cols: typing.SupportsInt | typing.SupportsIndex
    ) -> None:
        """
    ...
    def to_list(self) -> list[list[int]]:
        ...
        """
    def xor_bit(
        self, r: typing.SupportsInt | typing.SupportsIndex, c: typing.SupportsInt | typing.SupportsIndex
    ) -> None:
        """
        Flip the bit at (r, c).
        """
    def xor_rows(
        self, dst: typing.SupportsInt | typing.SupportsIndex, src: typing.SupportsInt | typing.SupportsIndex
    ) -> None:
        """
...
class PauliRerouter:
    def __init__(self, circuit: typing.Any) -> None: ...
    def get_S_and_L_matrices(
        self,
        observable_index: typing.SupportsInt | typing.SupportsIndex,
        lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
        optimize: bool = False,
    ) -> tuple[PackedF2Matrix, PackedF2Matrix]: ...
    def reroute(
        self,
        observable_index: typing.SupportsInt | typing.SupportsIndex,
        lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    ...
    def riroute(
        ...
        S: PackedF2Matrix,
        L: PackedF2Matrix,
        available_measurements: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    ) -> list[int]: ...
    @property
    def L(self) -> list: ...
    @property
...
class SampleBatch:
    ...
    def __init__(
        self,
        measurements: typing.Annotated[numpy.typing.ArrayLike, numpy.uint8],
        detectors: typing.Annotated[numpy.typing.ArrayLike, numpy.uint8],
        observables: typing.Annotated[numpy.typing.ArrayLike, numpy.uint8],
        loss_patterns: collections.abc.Sequence[
    ...
    def __init__(
        ...
        observables: typing.Annotated[numpy.typing.ArrayLike, numpy.uint8],
        loss_patterns: collections.abc.Sequence[
            collections.abc.Mapping[int, collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex]]
        ],
    ) -> None:
        """
...
def combine_circuits_into_dem(
    circuits: collections.abc.Sequence[typing.Any],
    weights: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] | None = None,
) -> typing.Any:
    """
...
def get_loss_dem(
    ...
    lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    life_segment: LifeSegment,
    optimize_rerouting: bool = False,
) -> typing.Any:
    """
    Get the effective DetectorErrorModel for a life segment with lost qubits.
    """

def get_loss_rewritten_circuits(
    circuit: LossyCircuit,
    lost_qubits: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex],
    life_segment: LifeSegment,
    optimize_rerouting: bool = False,
